"""``causalkg`` — bridge from a knowledge graph to causal discovery, model fitting and prediction."""
...
# Plan 2 modules (causalkg.model, .mechanisms, .entities, .inference, .queries,
# .evaluation) depend on dowhy.gcm / pgmpy and are intentionally *not*
# imported here — import them explicitly, e.g. ``from causalkg.model import
